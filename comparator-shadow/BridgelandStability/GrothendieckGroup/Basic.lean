...
-- ANCHOR: CategoryTheory.Triangulated.trianglePresentation
...
abbrev trianglePresentation :
  ...
  obj₂ := fun r => r.1.obj₂
  obj₃ := fun r => r.1.obj₃
-- ANCHOR_END: CategoryTheory.Triangulated.trianglePresentation

-- ANCHOR: CategoryTheory.Triangulated.K₀
...
-- ANCHOR_END: CategoryTheory.Triangulated.K₀

-- ANCHOR: CategoryTheory.Triangulated.K₀.instAddCommGroup
instance K₀.instAddCommGroup : AddCommGroup (K₀ C) :=
  inferInstanceAs (AddCommGroup (trianglePresentation C).K0)
-- ANCHOR_END: CategoryTheory.Triangulated.K₀.instAddCommGroup

-- ANCHOR: CategoryTheory.Triangulated.K₀.of
/-- The class map sending an object `X` of `C` to its class `[X]` in `K₀ C`. -/
def K₀.of (X : C) : K₀ C :=
  QuotientAddGroup.mk (FreeAbelianGroup.of X)
-- ANCHOR_END: CategoryTheory.Triangulated.K₀.of
...
variable {C} in
-- ANCHOR: CategoryTheory.Triangulated.IsTriangleAdditive
...
-- ANCHOR_END: CategoryTheory.Triangulated.IsTriangleAdditive

variable {C} in
-- ANCHOR: CategoryTheory.Triangulated.instIsAdditiveSubtypeTriangleMemSetDistinguishedTrianglesTrianglePresentationOfIsTriangleAdditive
...
-- ANCHOR_END: CategoryTheory.Triangulated.instIsAdditiveSubtypeTriangleMemSetDistinguishedTrianglesTrianglePresentationOfIsTriangleAdditive

-- ANCHOR: CategoryTheory.Triangulated.K₀.lift
...
-- ANCHOR_END: CategoryTheory.Triangulated.K₀.lift
...
-- ANCHOR: CategoryTheory.Triangulated.cl
...
-- ANCHOR_END: CategoryTheory.Triangulated.cl
