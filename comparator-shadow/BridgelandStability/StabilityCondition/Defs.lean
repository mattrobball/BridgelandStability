...
-- ANCHOR: CategoryTheory.Triangulated.PreStabilityCondition.WithClassMap
...
-- ANCHOR_END: CategoryTheory.Triangulated.PreStabilityCondition.WithClassMap

omit [IsTriangulated C] in
variable {C} in
-- ANCHOR: CategoryTheory.Triangulated.PreStabilityCondition.WithClassMap.charge
...
noncomputable abbrev WithClassMap.charge {v : K₀ C →+ Λ}
  ...
  σ.Z (cl C v E)
-- ANCHOR_END: CategoryTheory.Triangulated.PreStabilityCondition.WithClassMap.charge
...
-- ANCHOR: CategoryTheory.Triangulated.StabilityCondition.WithClassMap
...
-- ANCHOR_END: CategoryTheory.Triangulated.StabilityCondition.WithClassMap
...
open Real in
-- ANCHOR: CategoryTheory.Triangulated.slicingDist
...
-- ANCHOR_END: CategoryTheory.Triangulated.slicingDist

-- ANCHOR: CategoryTheory.Triangulated.stabSeminorm
...
-- ANCHOR_END: CategoryTheory.Triangulated.stabSeminorm

/-! ### Topology on Stab(D) -/

-- ANCHOR: CategoryTheory.Triangulated.basisNhd
...
-- ANCHOR_END: CategoryTheory.Triangulated.basisNhd

-- ANCHOR: CategoryTheory.Triangulated.StabilityCondition.WithClassMap.topologicalSpace
...
instance StabilityCondition.WithClassMap.topologicalSpace {v : K₀ C →+ Λ} :
  ...
  TopologicalSpace.generateFrom
    {U | ∃ (σ : StabilityCondition.WithClassMap C v) (ε : ℝ), 0 < ε ∧ ε < 1 / 8 ∧
      U = basisNhd C σ ε}
-- ANCHOR_END: CategoryTheory.Triangulated.StabilityCondition.WithClassMap.topologicalSpace

namespace StabilityCondition.WithClassMap

-- ANCHOR: CategoryTheory.Triangulated.StabilityCondition.WithClassMap.ComponentIndex
...
-- ANCHOR_END: CategoryTheory.Triangulated.StabilityCondition.WithClassMap.ComponentIndex

-- ANCHOR: CategoryTheory.Triangulated.StabilityCondition.WithClassMap.Component
...
-- ANCHOR_END: CategoryTheory.Triangulated.StabilityCondition.WithClassMap.Component
