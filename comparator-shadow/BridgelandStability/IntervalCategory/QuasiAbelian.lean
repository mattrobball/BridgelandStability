...
-- ANCHOR: CategoryTheory.Triangulated.Slicing.intervalCat_hasKernels
noncomputable instance Slicing.intervalCat_hasKernels (s : Slicing C) :
  ...
  ⟨fun {X Y} f ↦ Slicing.intervalCat_hasKernel (C := C) (s := s)
    (a := a) (b := b) (X := X) (Y := Y) f⟩
-- ANCHOR_END: CategoryTheory.Triangulated.Slicing.intervalCat_hasKernels
...
-- ANCHOR: CategoryTheory.Triangulated.Slicing.intervalCat_hasCokernels
noncomputable instance Slicing.intervalCat_hasCokernels (s : Slicing C) :
  ...
  ⟨fun {X Y} f ↦ Slicing.intervalCat_hasCokernel (C := C) (s := s)
    (a := a) (b := b) (X := X) (Y := Y) f⟩
-- ANCHOR_END: CategoryTheory.Triangulated.Slicing.intervalCat_hasCokernels
