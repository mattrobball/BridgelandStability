...
// Module: BridgelandStability.Deformation.Setup
...
LEAN_EXPORT lean_object* initialize_BridgelandStability_BridgelandStability_Deformation_Setup(uint8_t builtin) {
lean_object * res;
